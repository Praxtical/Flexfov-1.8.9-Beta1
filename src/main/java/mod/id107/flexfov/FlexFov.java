...
@Mod(modid = FlexFov.MOD_ID, name = FlexFov.MOD_NAME, version = FlexFov.MOD_VERSION, useMetadata = true, acceptedMinecraftVersions = "[1.8,1.8.9]", acceptableRemoteVersions = "*")
